...
subtitle: "BSTA 511/611 Fall 2025 Days 2-4, OHSU"
...
* (1.3) __Data collection principles__  - [Day 2 in F25]{style="color:darkorange"}
  - Population vs. sample
  - Sampling methods
  - Experiments vs. Observational studies

* (1.2) __Intro to Data__  - [Day 2 in F25]{style="color:darkorange"}
  - Data types
  - How are data stored in R?
  - Working with data in R
  
* (1.4) __Summarizing numerical data__   - [Day 3 in F25]{style="color:darkorange"}
  - Mean, median, mode, SD, IQR, range, 5 number summary
  - Empirical Rule
  - robust statistics

* __R packages__  - [Day 4 in F25]{style="color:darkorange"} -> __[install for Day 5!!!]{style="color:darkorange"}__
...
# (1.3) Data collection principles - Day 2 in F25
...
[Science Media Centre](https://www.sciencemediacentre.co.nz/coveringscience/types-of-scientific-evidence/)

## Systematic Reviews example

[STEM: Systematically Testing the Evidence on Marijuana](https://www.cannabisevidence.org/)
...
[Gapminder Dollarstreet water sources](https://www.gapminder.org/dollar-street?topic=get-water)
